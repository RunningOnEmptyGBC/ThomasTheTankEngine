...
bool ColourShader::Init(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitShader(device, hwnd, L"../Resources/Shaders/Colour.vs", L"../Resources/Shaders/Colour.ps");
	if (!result)
	{
		return false;
	}
...
bool ColourShader::InitShader(ID3D11Device* device, HWND hwnd, const wchar_t* vsFilename, const wchar_t* psFilename)
{
	HRESULT result;
