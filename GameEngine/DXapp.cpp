...
bool DXapp::Init(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen,
	float screenDepth, float screenNear)
{
	...
	//Retrieve adapter name and memory amount
	...
	//card structure and interface release
	...
	////depth buffer and stencil buffer descripter
	...
	//Setting up depth stencil buffer
...
void DXapp::BeginScene(float red, float green, float blue, float alpha)
{
	float color[4];
...
void DXapp::GetVideoCardInfo(char* cardName, int& memory)
{
